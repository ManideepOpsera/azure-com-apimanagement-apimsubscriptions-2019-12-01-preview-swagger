...
func Subscription_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateSubscription_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_subscriptions_sid",
		mcp.WithDescription("Deletes the specified subscription."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Subscription_deleteHandler(cfg),
	}
}
