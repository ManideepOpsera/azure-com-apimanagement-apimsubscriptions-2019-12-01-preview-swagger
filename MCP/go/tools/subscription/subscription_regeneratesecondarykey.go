...
func Subscription_regeneratesecondarykeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/subscriptions/%s/regenerateSecondaryKey%s", cfg.BaseURL, resourceGroupName, serviceName, sid, subscriptionId, queryString)
...
func CreateSubscription_regeneratesecondarykeyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_subscriptions_sid_regenerateSecondaryKey",
		mcp.WithDescription("Regenerates secondary key of existing subscription of the API Management service instance."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Subscription_regeneratesecondarykeyHandler(cfg),
	}
}
