...
func Subscription_regenerateprimarykeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/subscriptions/%s/regeneratePrimaryKey%s", cfg.BaseURL, resourceGroupName, serviceName, sid, subscriptionId, queryString)
...
func CreateSubscription_regenerateprimarykeyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_subscriptions_sid_regeneratePrimaryKey",
		mcp.WithDescription("Regenerates primary key of existing subscription of the API Management service instance."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Subscription_regenerateprimarykeyHandler(cfg),
	}
}
